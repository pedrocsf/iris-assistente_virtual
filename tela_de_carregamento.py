...
class TimerApp:
    def __init__(self, root, tempo_para_fechar):
        ...
        self.image2 = Image.open(r"H:\Meu Drive\UFG\1º Período\Introdução à engenharia de computação\Projeto final\Íris FINAL\iris_carregamento.png")
